...
func newSysOperationLog(db *gorm.DB, opts ...gen.DOOption) sysOperationLog {
	...
	_sysOperationLog.IsDelete = field.NewBool(tableName, "is_delete")
	...
	_sysOperationLog.Params = field.NewString(tableName, "params")
	_sysOperationLog.Result = field.NewString(tableName, "result")
	_sysOperationLog.Status = field.NewInt32(tableName, "status")
	_sysOperationLog.Duration = field.NewInt64(tableName, "duration")
...
func (s *sysOperationLog) WithContext(ctx context.Context) ISysOperationLogDo {
