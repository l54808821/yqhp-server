...
// Type aliases for backward compatibility - these types are now defined in pkg/types
type (
	SlaveRegisterRequest    = types.SlaveRegisterRequest
	SlaveRegisterResponse   = types.SlaveRegisterResponse
	ResourceInfo            = types.APIResourceInfo
	SlaveHeartbeatRequest   = types.SlaveHeartbeatRequest
	SlaveStatusInfo         = types.APISlaveStatusInfo
	SlaveMetrics            = types.APISlaveMetrics
	SlaveHeartbeatResponse  = types.SlaveHeartbeatResponse
	ControlCommand          = types.ControlCommand
	PendingTasksResponse    = types.PendingTasksResponse
	TaskAssignment          = types.TaskAssignment
	ExecutionSegment        = types.APIExecutionSegment
	ExecutionOptions        = types.APIExecutionOptions
	Stage                   = types.APIStage
	TaskResultRequest       = types.TaskResultRequest
	ExecutionErrorRequest   = types.ExecutionErrorRequest
	TaskResultResponse      = types.TaskResultResponse
	MetricsReportRequest    = types.MetricsReportRequest
	MetricsData             = types.APIMetricsData
	StepMetricsData         = types.StepMetricsData
	DurationMetricsData     = types.DurationMetricsData
	MetricsReportResponse   = types.MetricsReportResponse
	SlaveUnregisterRequest  = types.SlaveUnregisterRequest
	SlaveUnregisterResponse = types.SlaveUnregisterResponse
)
