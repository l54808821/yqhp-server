...
// filterToolsForStep returns all tools for each plan step.
// With the read_skill model, the agent naturally loads relevant skills per step via read_skill,
// so no skill-based filtering is needed.
